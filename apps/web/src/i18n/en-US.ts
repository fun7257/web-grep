...
export const enUS = {
  ...
  treeFolderError: "Could not load this folder",
  treeRetry: "Retry",
  treeTruncated: "This folder has more entries than are shown",
  pickTooLong: "Path is too long, so this search was not sent",
  pickTooLongSkipped: "Skipped {n} paths that are too long to search",
  paneHits: "Results",
  resultSortLine: "Line",
